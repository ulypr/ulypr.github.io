...
function setHands(){
  ...
  if (sec/60 > 0.0 && sec/60 < 0.5) 
    {
        document.querySelector("#flo").style.opacity = "1";
        document.querySelector("#noflo").style.opacity = "0"
    } 
  else 
    {

        document.querySelector("#noflo").style.opacity = "1";
        document.querySelector("#flo").style.opacity = "0";
    }
}
